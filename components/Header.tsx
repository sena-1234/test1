    ...
    <div className="flex items-center gap-3">
      {(!logoError) ? (
        <img
          ...
          className={`h-12 md:h-14 w-auto object-contain transition-all duration-500 group-hover:scale-110 ${!isScrolled ? 'brightness-0 invert' : ''}`}
        ...
        <div className="flex items-center gap-2 transition-all duration-500">
          ...
          <div className="flex flex-col">
            ...
            <span className={`text-2xl md:text-4xl font-black tracking-tighter leading-none mt-1 ${isScrolled ? 'text-brand-dark' : 'text-white'}`}>TERARA</span>
          </div>
        </div>
      )}
    </div>
