...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-brand-dark border-t border-gray-800 text-white pt-16 pb-8" aria-label="Site footer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16 mb-12">
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Addis Ababa based printing company offering offset, digital, large format, and packaging solutions for clients across Ethiopia since 2017 G.C.
            </p>
          ...
          <div>
            <h2 className="font-bold text-lg mb-6 border-b border-brand-red pb-2 inline-block">Explore</h2>
          ...
          <div>
            <h2 className="font-bold text-lg mb-6 border-b border-brand-red pb-2 inline-block">Services</h2>
            <ul className="space-y-3 text-gray-400 text-sm">
