    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-12 mb-12">
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-11 h-11 rounded-full bg-gray-800 flex items-center justify-center p-2 hover:bg-brand-red transition-colors"
              >
                <Facebook size={20} />
                <span className="sr-only">Terara Printers on Facebook</span>
              </a>
              <a
              ...
              >
                <Instagram size={20} />
                <span className="sr-only">Terara Printers on Instagram</span>
              </a>
              <a
              ...
              >
                ...
                <span className="sr-only">Terara Printers on TikTok</span>
              </a>
              <a
              ...
              >
                <Linkedin size={20} />
                <span className="sr-only">Terara Printers on LinkedIn</span>
              </a>
              <a
                href="https://t.me/teraraprinters"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                <Send size={20} />
                <span className="sr-only">Terara Printers on Telegram</span>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              <li>
                <a
                  href="/services/marketing-brand-collateral.html"
                  className="hover:text-brand-red transition-colors"
                >
              ...
              <li>
                <a
                  href="/services/event-materials.html"
                  className="hover:text-brand-red transition-colors"
                >
                  Event Materials
                </a>
              ...
              <li>
                <a
                  href="/services/short-run-printing.html"
                  className="hover:text-brand-red transition-colors"
                >
                  Short-Run
                </a>
              ...
              <li>
                <a
                  href="/services/large-format-specialty.html"
                  className="hover:text-brand-red transition-colors"
                >
              ...
              <li>
                <a
                  href="/services/business-stationery.html"
                  className="hover:text-brand-red transition-colors"
                >
                  Business Stationery
                </a>
              ...
              <li>
                <a
                  href="/services/custom-packaging.html"
                  className="hover:text-brand-red transition-colors"
                >
                  Custom Packaging
                </a>
              ...
              <li>
                <a
                  href="/services/promotional-products.html"
                  className="hover:text-brand-red transition-colors"
                >
          ...
          <div className="md:justify-self-start md:text-left">
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              ...
              <li>
                <a
                  href="https://maps.google.com/?q=9.0337315,38.7610906"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-brand-red transition-colors"
                >
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <button
            onClick={scrollToTop}
            className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-white hover:bg-brand-red transition-colors shadow-lg"
