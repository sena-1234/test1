...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We handle Offset, short-run, large-format, stationery, branding materials, and custom packaging in one place. This gives clients better quality control and simpler coordination.",
  },
  {
  ...
  },
  {
    ...
    answer: "4 Killo, Dink Sira Tower, 1st Floor.",
  },
  {
  ...
  },
  {
    ...
    answer: "PDF is best. We also accept AI files and high-resolution images.",
  },
  {
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="relative mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            ...
            <h2
              id="faq-heading"
              className="mx-auto mb-4 max-w-4xl text-4xl font-black text-brand-dark md:text-5xl"
            >
          ...
          <div className="grid gap-8 lg:grid-cols-[1.65fr_0.95fr] lg:items-start">
            <div className="space-y-4">
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        <h3 className="text-lg font-black leading-snug text-brand-dark md:text-xl">
                          {faq.question}
                        </h3>
                      </div>
                      <span
              ...
              <div className="pt-2">
                <a
                  href="/faq.html"
                  className="inline-flex items-center justify-center rounded-full border-2 border-brand-red px-5 py-2.5 text-sm font-bold uppercase tracking-wide text-brand-red transition-all hover:bg-brand-red hover:text-white"
                >
                  See more
                </a>
              </div>
            ...
            <aside className="space-y-5 lg:sticky lg:top-24">
                  ...
                  <div className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/5 p-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        Standard jobs are completed quickly, with urgent jobs
                        prioritized after review.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="rounded-3xl border border-brand-red/15 bg-white/90 p-7 shadow-lg backdrop-blur-sm">
                <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-red/10 text-brand-red">
                  <MapPin size={22} />
                </div>
                <p className="mb-3 text-sm font-bold uppercase tracking-[0.25em] text-brand-red">
                  Visit Us
                </p>
                <h3 className="mb-3 text-2xl font-black text-brand-dark">
